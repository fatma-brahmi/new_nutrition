        ...
        <form method="post">
          <div className="row">
            ...
            <div className="col-md-2">
             <Link to ={`/edit/${profilInfo._id}`}><button  type="submit" className="profile-edit-btn" name="btnAddMore" defaultValue="Edit Profile">Edit Profile</button> </Link> 
              <Link to="/add">
              <button type="submit" className="profile-edit-btn" name="btnAddMore" defaultValue="Add Articl" >Add Articl</button>
              </Link>
            </div>
          </div>
